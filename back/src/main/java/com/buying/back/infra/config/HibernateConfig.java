...
import com.buying.back.infra.interceptor.EntityChangeInterceptor;
...
public class HibernateConfig {
  ...
  private final EntityChangeInterceptor entityChangeInterceptor;
  ...
  public HibernatePropertiesCustomizer hibernatePropertiesCustomizer() {
    return hibernateProperties -> {
      ...
      hibernateProperties.put("hibernate.ejb.interceptor", entityChangeInterceptor);
    };
  }
